...
//     }
//   };
//   const recargarGrid = (_fecha: string) => {
//     setReload(Date.now());
//   };
//   return (
...
//         <FormCupones accion={modalCupones.accion} id={modalCupones.id} onClose={() => setmodalCupones({ show: false, id: 0, accion: '' })} formDisabled={formDisabled} setRecargaGrid={recargarGrid}/>
//       </ModalDinamico>
//     </div>
//   )
// };
